...
export default function DashboardPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      router.push(`${ROUTES.PREVIEW}?sessionId=${data.sessionId}`)
    } catch (err: any) {
  ...
  return (
    <div className="max-w-2xl mx-auto flex flex-col gap-8">
      ...
      {/* Form card */}
      <div className="animate-fade-up-delay-1 p-6 rounded-2xl border border-[var(--border-accent)] flex flex-col gap-6" style={{background: 'var(--surface)'}}>
